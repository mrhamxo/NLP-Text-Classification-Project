...
from normal_hate.entity.config_entity import ModelTrainerConfig
from normal_hate.entity.artifact_entity import ModelTrainerArtifacts,DataTransformationArtifacts
from normal_hate.ml.model import ModelArchitecture
